...
grunt.tasks = function(tasks, options, done) {
  ...
  if (option('version')) {
    ...
    if (option('verbose')) {
      ...
      // Display available tasks (for shell completion, background).
      _tasks = Object.keys(grunt.task._tasks).sort();
      verbose.writeln('Available tasks: ' + _tasks.join(' '));

      // Display available options (for shell completion, background).
      _options = [];
  ...
  // Report, background when all tasks have completed.
  task.options({
    error: function(e) {
