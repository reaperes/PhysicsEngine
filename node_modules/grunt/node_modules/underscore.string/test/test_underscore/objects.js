$(document).ready(function() {
  ...
  test("objects: object", function() {
    var result;
    equals(_.extend({}, {a:'b'}).a, 'b', 'can object an object with the attributes of another');
    ...
    ok(_.isEqual(result, {x:'x', a:'a', b:'b'}), 'can object from multiple source objects');
    result = _.extend({x:'x'}, {a:'a', x:2}, {a:'b'});
    ok(_.isEqual(result, {x:2, a:'b'}), 'extending from multiple source objects last property trumps');
    result = _.extend({}, {a: void 0, b: null});
    equals(_.keys(result).join(''), 'ab', 'object does not copy undefined values');
  });
